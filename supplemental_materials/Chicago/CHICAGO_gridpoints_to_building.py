...
fp = f'{dir}/../WRF_AutoBEM/sample_data_fromWRF_forAutoBEM/chi0_90m_wrfcoord2bldg.csv'
df = pd.read_csv(fp)
...
# print(gdf)
fp = f"{dir}/../WRF_AutoBEM/test_dir/ChicagoLoop_Morph1.shp"
...
fp = f'{dir}/../WRF_AutoBEM/sample_data_fromWRF_forAutoBEM/chi_90m_grid.csv'
df = pd.read_csv(fp)
...
output.to_csv('CHICAGO_matched.csv')
